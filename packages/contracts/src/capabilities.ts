...
export const V1_CAPABILITY_MATRIX: readonly CapabilityRow[] = Object.freeze([
  ...
  },
  {
    ...
    ios: "not-shipped",
    android: "not-shipped",
    notes: "External loopback llama.cpp-compatible server; fails closed when absent. An invalid typed draft and an invalid search query are each repaired once. Not verified on a headed Windows release profile.",
  },
  {
