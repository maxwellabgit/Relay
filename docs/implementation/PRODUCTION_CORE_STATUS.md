...
| 3 Decompose engine | GREEN | Services extracted; correlation; txn; crash tests; verify:v1 PASS |
...
Start Phase 4 (tool and operation kernel) after Bugbot PASS on Phase 3 commit.
